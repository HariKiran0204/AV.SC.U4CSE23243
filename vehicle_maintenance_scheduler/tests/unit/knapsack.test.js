...
const knapsack_1 = require("../../src/algorithms/knapsack");
describe("knapsack", () => {
    it("selects optimal tasks", () => {
        ...
        const result = (0, knapsack_1.solveKnapsack)(tasks, 5);
    ...
    it("1D DP returns same best score", () => {
        ...
        expect((0, knapsack_1.optimizeScheduleSpaceEfficient)(tasks, 5)).toBe(16);
    });
});
